                ...
                foreach($ventes as $vente){ ?>
                    <tr>
                        ...
                        <td class="border-t py-2 px-4 text-center">
                            ...
                            <button class="ml-2"><a href="suppresion.php?action=delete&client=<?php echo $vente->id_clients ?>&vendus=<?php echo $vente->id_vente ?>"><i class="fas fa-trash text-red-500 hover:text-red-700"></i></a> </button>
